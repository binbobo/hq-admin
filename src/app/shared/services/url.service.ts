export class Urls {
    ...
    public static readonly chain = !Urls.debug ? Urls.base.concat('chain') : "http://localhost:8012/api/";
    // public static readonly configuration = !Urls.debug ? Urls.base.concat('chain') : "http://localhost:8012/api/";
